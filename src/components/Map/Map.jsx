    ...
    return (
      <div>
        ...
        <div className="info-box" id="choices_desktop">
          <ul>
            <li
              className={this.state.selected === "cases" ? "active" : undefined}
              onClick={() => {
            ...
            <li
              className={
                this.state.selected === "active" ? "active" : undefined
              }
              onClick={() => {
            ...
            <li
              className={
                this.state.selected === "recovered" ? "active" : undefined
              }
              onClick={() => {
            ...
            <li
              className={
                this.state.selected === "deaths" ? "active" : undefined
              }
              onClick={() => {
        ...
        <div className="info-box" id="total">
          ...
          <p>
            <b>New cases </b>
            <span style={{ color: "#A90000" }}>
              {this.state.dataTotal.new_cases}
            </span>
          </p>
          <p>
            <b>Total recovered </b>
            <span style={{ color: "#28a745" }}>
              {this.state.dataTotal.total_recovered}
            </span>
          </p>
          <p>
            <b>Total deaths </b>
